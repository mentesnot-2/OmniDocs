...
| Testing | `pytest` | pinned | Test harness in `tests/conftest.py`; suites in `tests/test_auth.py`, `tests/test_file_validation.py`, and `tests/test_verification_token.py`. |
